...
PAUSA_APOS_FALHA_PLACA = 100
PAUSA_CADA_N_PLACAS = 40
PAUSA_LOTE_GRANDE = 60
TEMPO_AGUARDAR_MUNICIPIO = 900
TEMPO_AGUARDAR_ENDERECOS = 900
...
# ============================================================
# MATRIZ DE PLACAS PARA TESTE
# ============================================================
# Coloque aqui as placas que deseja processar.
# Exemplo:
    ...
    for tentativa in range(1, max_tentativas + 1):
        ...
        try:
            ...
            if tentativa < max_tentativas:
                espera = delay_inicial * (8 ** (tentativa - 1))
...
def main():
    ...
    try:
        ...
        # Gera o Excel e envia o MESMO DataFrame para RESULTADOS.
